  ...
  admin: {
    ...
    settings: {
      ...
      site: {
        ...
        brandingSlotsTitle: 'Branding Slots',
        brandingSlotsDescription: 'Inject trusted HTML/CSS into fixed areas of login, register, payment, and footer layouts.',
        resetBrandingSlots: 'Reset to Default',
        customCss: 'Custom CSS',
        customCssPlaceholder: '/* Applied globally after settings are saved */',
        customCssHint: 'Injected as a global <style> tag. JavaScript is not supported.',
        loginExtraHtml: 'Login Page HTML',
        registerExtraHtml: 'Register Page HTML',
        paymentFooterHtml: 'Payment Footer HTML',
