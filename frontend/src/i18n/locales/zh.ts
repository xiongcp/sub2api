export default {
  ...
  keyUsage: {
    ...
    query: '查询',
    querying: '查询中...',
    privacyNote: 'API Key 仅用于本次查询校验，请勿在不可信环境输入',
    dateRange: '统计范围:',
    dateRangeToday: '今日',
    dateRange7d: '7 天',
    dateRange30d: '30 天',
  ...
  admin: {
    ...
    accounts: {
      ...
      capacity: {
        ...
        quota: {
          ...
          normal: '配额正常',
          lowQuotaThreshold: '已配置低额度停调度阈值',
          lowQuotaThresholdTriggered: '账号剩余额度低于阈值，当前不参与调度'
        },
      },
      ...
      quotaMinRemaining: '最低剩余额度阈值',
      quotaMinRemainingPlaceholder: '留空表示不启用',
      quotaMinRemainingHint: '当总剩余额度低于该值时，账号将停止参与调度。',
      quotaMinRemainingRatio: '最低剩余额度比例阈值',
      quotaMinRemainingRatioPlaceholder: '留空表示不启用',
      quotaMinRemainingRatioHint: '当总剩余额度 / 总额度低于该比例时，账号将停止参与调度。',
      quotaResetMode: '重置方式',
    ...
    settings: {
      ...
      site: {
        ...
        brandingSlotsTitle: '品牌插槽',
        brandingSlotsDescription: '向登录、注册、支付和页脚等固定区域注入受信任的 HTML/CSS。',
        resetBrandingSlots: '恢复默认',
        customCss: '自定义 CSS',
        customCssPlaceholder: '/* 保存后会作为全局样式生效 */',
        customCssHint: '会注入为全局 <style> 标签，不支持 JavaScript。',
        loginExtraHtml: '登录页 HTML',
        registerExtraHtml: '注册页 HTML',
        paymentFooterHtml: '支付页底部 HTML',
